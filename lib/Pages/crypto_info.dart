...
Text(widget.coinPrice, style:Theme.of(context).textTheme.titleLarge),
 ...
 SizedBox(width: sizeHeight/65),

Padding(
padding: const EdgeInsets.only(top: 7),
child: Container( width: sizeWidth/6, height: 25, decoration: BoxDecoration(
color: Palette.chipColor, borderRadius: BorderRadius.circular(10),
),
child: const Center(
child: Text( '+0.05 %', style: TextStyle(
...
const Text( 'At Close December 31st 2024 - 11.59 PM', style: TextStyle(fontSize: 16, color: Colors.black45),
...
child: Container( height: sizeHeight/16, width: sizeWidth/7,
decoration: BoxDecoration( color: widget.color, borderRadius: const BorderRadiusDirectional.horizontal(
...
dividerHeight: 0, indicatorWeight: 0.5, labelColor: Colors.black, unselectedLabelColor: Colors.black45,
tabs: [
